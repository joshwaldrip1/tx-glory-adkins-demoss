...
const SOCIAL = {
  ...
  gamechanger: { label: "GameChanger", path: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 2a8 8 0 0 1 5.29 2H6.71A8 8 0 0 1 12 4ZM4 12a8 8 0 0 1 1.06-3.98l2.02 2.02A4.98 4.98 0 0 0 7 12c0 .69.14 1.34.39 1.94l-2.02 2.02A7.97 7.97 0 0 1 4 12Zm8 8a8 8 0 0 1-5.29-2h10.58A8 8 0 0 1 12 20Zm6.94-4.04-2.02-2.02c.25-.6.39-1.25.39-1.94 0-.69-.14-1.34-.39-1.94l2.02-2.02A8 8 0 0 1 20 12a7.97 7.97 0 0 1-1.06 3.96Z" },
...
function socialIcon(s) {
  ...
  return `<a class="social-link" href="${esc(s.url)}" target="_blank" rel="noopener" aria-label="${esc(g.label)}" title="${esc(g.label)}"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="${g.path}"/></svg></a>`;
}
